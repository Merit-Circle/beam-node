...
export type TakeOwnershipResponse = {
  id: string;
  object: string;
  createdAt: number;
  updatedAt: number;
  ...
  userOperation?: any;
  nextAction?: {
    type: TakeOwnershipResponse.type;
    payload: {
      userOp?: any;
      userOpHash?: string;
    };
  ...
  policy?: {
    ...
    chainId: number;
    strategy: {
      sponsorSchema: TakeOwnershipResponse.sponsorSchema;
...
export namespace TakeOwnershipResponse {
  export enum type {
